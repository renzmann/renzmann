...
(global-set-key (kbd "C-; p e") 'pyvenv-activate)
(global-set-key (kbd "C-; p d") 'pyvenv-deactivate)
(global-set-key (kbd "C-; p f") 'elpy-black-fix-code)
...
(global-set-key (kbd "C-; v") 'evil-mode)
